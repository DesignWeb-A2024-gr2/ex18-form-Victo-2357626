...
const messageE = document.querySelector(".message-erreur")
const eye = '<i class="fa-solid fa-eye"></i>'
const eyeSlash = '<i class="fa-solid fa-eye-slash"></i>';
...
inp2.addEventListener("keyup",(e)=>{
    if (e.target.value) {
       if (e.target.value === inp1.value) {
        inp2.style.borderBlockColor="green"
        messageE.style.display = ""


       } else {
        inp2.style.borderBlockColor = "red"
...
show.onclick = ()=> {
   if(inp1.type == "password" && inp2.type == "password"){
    inp1.type = "text"
    inp2.type = "text"
    this.innerHTML = eye
   }
